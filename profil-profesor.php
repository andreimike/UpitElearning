                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 profile-header">
                                ...
                                <div class="row banner-down no-gutters">
                                    ...
                                    <div class="col-lg-3 offset-lg-1 col-md-3 offset-md-1 col-sm-10 col-xs-12 flex-unordered">
                                        <p class="profileTextPerson text-center nume-text-profil">Nume Prenume</p>
                                    </div>
                                    <div class="col-lg-2 col-md-3 col-sm-12 col-xs-12 flex-unordered">
                                        <ul class="nav navbar-nav navbar-left" style="padding-top: 13px !important;">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li class="notification-box"><a href="#" class="login">Notificarea 1</a></li>
                                                    <li><a href="#" class="login">Notificarea 2</a></li>
                                                    <li><a href="#" class="login">Notificarea 3</a></li>
                                                    <li><a href="#" class="login">Notificarea 4</a></li>
                                                    <li><a href="#" class="login">Vezi tot</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-4 col-md-3 col-sm-12 col-xs-12 flex-last">
                                        ...
                                        <br />
                                        <p class="profileTextPerson3 text-center">Grad profesor | Materii</p> 
                                        <br />
                                        <a href="lista-studenti.php"><p class="profileTextPerson3 text-center">Lista stundeti</p></a>
                                    </div>
                                </div>
                            </div>                    
                        </div>
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col col-lg-2 col-md-2 col-sm col-sm">
                                        <form id="an" name="an" method="post">
                                            <div class="controls">
                                                <select id="an" name="an" class="btn btn-primary textarea-submit-btn" type="button" aria-haspopup="true" aria-expanded="false">
